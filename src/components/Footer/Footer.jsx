        ...
        <div className="bg-neutral">
            <footer className="footer p-10 text-neutral-content max-w-7xl mx-auto flex justify-between">
                <aside>
                    ...
                    <p>Job Market X<br />Providing Reliable Employee & Recruter</p>
                </aside>
                <nav>
            ...
            <h1 className="footer-title mb-0  text-white text-center">Copyright © {copyRightYear.toLocaleString('en-us', { month: 'long' })} {copyRightYear.getFullYear()} - All right reserved</h1>
            <h1 className="footer-title mb-0  text-white text-center">
                <Link to={"https://github.com/NFRIDOY"} >Developed by <span className="text-warning">NF RIDOY</span></Link>
            </h1>
